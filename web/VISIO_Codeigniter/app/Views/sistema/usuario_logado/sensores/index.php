<?= view('sistema/layout/header_logado') ?>
        ...
        <div class="cardi" onclick="mostrarLuz()">
            <h3>Sensor de Luz</h3>
            <img src="./assets/images/Sensores/sensor_luz.png.jpeg" alt="Sensor de luz">
        ...
        <div class="cardi" onclick="mostrarMovimento()">
            ...
            <img src="./assets/images/Sensores/sensor_movimento.png.jpeg" alt="Sensor de movimento">
        ...
        <div class="cardi" onclick="mostrarGas()">
            ...
            <img src="./assets/images/Sensores/sensor_gas.png.jpeg" alt="Sensor de gás">
        ...
        <div class="cardi" onclick="mostrarToque()">
            ...
            <img src="./assets/images/Sensores/sensor_toque.png.jpeg" alt="Sensor de toque">
            <p>Reconhece o contato físico direto em superfícies sensíveis ao toque.</p>
                ...
                `, "./assets/images/Sensores/sensor_luz.png.jpeg");
                }
                ...
                `, "./assets/images/Sensores/sensor_movimento.png.jpeg");
                }
                ...
                `, "./assets/images/Sensores/sensor_gas.png.jpeg");
                }
                ...
                `, "./assets/images/Sensores/sensor_toque.png.jpeg");
                }
                </script>
